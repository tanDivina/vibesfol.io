...
const supabaseKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InducWpxanFqcWpxanFqcWoiLCJyb2xlIjoiYW5vbiIsImlhdCI6MTczNjEyNzI5NCwiZXhwIjoyMDUxNzAzMjk0fQ.Zt8Ej8Ej8Ej8Ej8Ej8Ej8Ej8Ej8Ej8Ej8Ej8Ej8Ej8';
...
async function insertSampleData() {
  try {
    ...
    const projectTechnologies = [
      // E-commerce Platform
      { project_id: 'project-1', technology_id: technologies.find(t => t.name === 'React')?.id },
      { project_id: 'project-1', technology_id: technologies.find(t => t.name === 'Node.js')?.id },
      { project_id: 'project-1', technology_id: technologies.find(t => t.name === 'PostgreSQL')?.id },
      
      // Task Management App
      { project_id: 'project-2', technology_id: technologies.find(t => t.name === 'Vue.js')?.id },
      { project_id: 'project-2', technology_id: technologies.find(t => t.name === 'Express.js')?.id },
      { project_id: 'project-2', technology_id: technologies.find(t => t.name === 'MongoDB')?.id },
      
      // Weather Dashboard
      { project_id: 'project-3', technology_id: technologies.find(t => t.name === 'Next.js')?.id },
      { project_id: 'project-3', technology_id: technologies.find(t => t.name === 'TypeScript')?.id },
      { project_id: 'project-3', technology_id: technologies.find(t => t.name === 'Tailwind CSS')?.id }
