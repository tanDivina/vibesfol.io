...
<svelte:head>
  ...
  <meta
    name="description"
    content="Privacy Policy for {WebsiteName} - How we collect, use, and protect your personal information."
  />
</svelte:head>
...
<div class="min-h-screen bg-base-100">
  <div class="container mx-auto px-4 py-16 max-w-4xl">
    ...
    <div class="prose prose-lg mx-auto">
      ...
      <p>
        Welcome to {WebsiteName} ("we," "our," or "us"). We are committed to protecting
        your privacy and ensuring you have a positive experience on our website and
        in using our services. This Privacy Policy explains how we collect, use,
        disclose, and safeguard your information when you visit our website and use
        our portfolio platform services.
      </p>
      ...
      <ul>
        ...
        <li>Professional information (company name, website, bio)</li>
        <li>
          Portfolio content (projects, descriptions, screenshots, testimonials)
        </li>
      ...
      <ul>
        ...
        <li>Creating and hosting your portfolio</li>
      ...
      <p>
        Your portfolio information that you choose to make public (such as your
        name, bio, projects, and contact information) will be visible to anyone
        who visits your portfolio page. You control what information is
        displayed publicly through your privacy settings.
      </p>
      ...
      <ul>
        ...
        <li>
          <strong>Screenshot Services:</strong> Automated screenshot generation
        </li>
        <li>
          <strong>Hosting Providers:</strong> Website hosting and content delivery
        </li>
      </ul>
      ...
      <p>
        ...
        retention period is required or permitted by law. When you delete your
      ...
      <h3>7.1 Managing Your Information</h3>
      <p>
        You can manage your personal information through your account settings:
      </p>
      <ul>
        <li>Update your profile information</li>
        <li>Control what information is publicly displayed</li>
      ...
      <p>
        ...
        with applicable data protection laws and that appropriate safeguards are
        in place.
      </p>
      ...
      <p>
        ...
        personal information, please contact us so we can delete such
        information.
      </p>
      ...
      you to review the privacy policies of any third-party sites you visit. Your
      portfolio information that you choose to make public (such as your name, bio,
      projects, and contact information) will be visible to anyone who visits your
      portfolio page. You control what information is displayed publicly through
      ...
      you of any material changes by posting the new Privacy Policy on this page
      and updating the "Last updated\" date. We implement appropriate technical and
      ...
      please contact us: We retain your personal information only for as long as
      ...
      account, we will delete your personal information, though some information
      may be retained for legal or legitimate business purposes.
      <ul>
        <li>Through our <a href="/contact_us" class="link">contact form</a></li>
        <h2>7. Your Rights and Choices</h2>
        <p>
          Depending on your location, you may have certain rights regarding your
          personal information:
        ...
        <h3>7.1 Managing Your Information</h3>
        <p>
          You can manage your personal information through your account
          settings:
        </p>
        <ul>
          <li>Update your profile information</li>
        ...
        <h2>8. International Data Transfers</h2>
        <li>
          Through your account settings if you have specific requests about your
          data
        </li>
        Your information may be transferred to and processed in countries other than
        your own. We ensure that such transfers are conducted in accordance with
        applicable data protection laws and that appropriate safeguards are in place.

        <h2>13. GDPR Compliance (EU Users)</h2>
        <h2>9. Children's Privacy</h2>
        If you are located in the European Union, you have additional rights under
        the General Data Protection Regulation (GDPR): Our services are not intended
        for children under the age of 13. We do not knowingly collect personal information
        from children under 13. If you are a parent or guardian and believe your
        ...
        <ul>
          ...
          Consumer Privacy Act (CCPA): If you have any questions about this Privacy
          Policy or our privacy practices, please contact us:
          <ul>
            <ul>
              <li>
                Through our <a href="/contact_us" class="link">contact form</a>
              </li>
              <li>By email: privacy@mydevfol.io</li>
              <li>
                Through your account settings if you have specific requests
                about your data
              </li>
            </ul>
