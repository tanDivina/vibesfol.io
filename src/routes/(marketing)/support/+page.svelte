...
<svelte:head>
  <title>Support - {WebsiteName}</title>
  <meta name="description" content="Get help and support for {WebsiteName}. Find answers to common questions and contact our support team." />
</svelte:head>
  ...
  <div class="container mx-auto px-4 py-16 max-w-4xl">
    ...
    <div class="text-center mb-12">
      ...
      <p class="text-xl text-gray-600 max-w-3xl mx-auto">
        Get help with your developer portfolio and find answers to common questions
      </p>
    </div>
    ...
    <div class="grid md:grid-cols-3 gap-8 mb-16">
      <div class="card bg-base-100 shadow-xl">
        <div class="card-body text-center">
          ...
          <p class="text-gray-600 mb-4">Learn how to create your first portfolio</p>
          <a href="/blog/how-to-build-a-killer-developer-portfolio" class="btn btn-primary btn-sm">Read Guide</a>
        </div>
      </div>
      ...
      <div class="card bg-base-100 shadow-xl">
        <div class="card-body text-center">
          ...
          <p class="text-gray-600 mb-4">Get personalized help from our team</p>
          <a href="/contact_us" class="btn btn-primary btn-sm">Contact Us</a>
        </div>
      </div>
      ...
      <div class="card bg-base-100 shadow-xl">
        <div class="card-body text-center">
          ...
          <a href="/blog" class="btn btn-primary btn-sm">View Blog</a>
        </div>
      </div>
    </div>
    ...
    <div class="bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg p-8 text-center">
      ...
      <div class="flex flex-col sm:flex-row gap-4 justify-center">
        <a href="/contact_us" class="btn btn-primary">
          Contact Support
        </a>
    ...
    <div class="mt-16">
      <h2 class="text-2xl font-bold text-center mb-8">Additional Resources</h2>
      <div class="grid md:grid-cols-2 gap-8">
        <div class="card bg-base-100 shadow-lg">
          <div class="card-body">
            <h3 class="card-title">📚 Documentation</h3>
            <p class="text-gray-600">
              Comprehensive guides and tutorials to help you make the most of your portfolio.
            </p>
            <div class="card-actions">
              <a href="/blog" class="btn btn-outline btn-sm">Browse Blog</a>
            </div>
          </div>
        </div>
        ...
        <div class="card bg-base-100 shadow-lg">
          <div class="card-body">
            ...
            <div class="card-actions">
              <a href="/contact_us" class="btn btn-outline btn-sm">Submit Idea</a>
            </div>
          </div>
        </div>
      </div>
