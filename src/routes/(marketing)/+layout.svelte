    ...
    <div class="footer-bottom border-t border-base-300 pt-8 mt-8">
      <div class="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center">
        ...
        <div class="flex items-center gap-4 mt-4 md:mt-0">
          <span class="text-sm text-base-content/70">Built for developers, by developers</span>
          <a href="https://github.com/CriticalMoments/CMSaasStarter" class="btn btn-ghost btn-sm">
