<script lang="ts">
  ...
  function handleSubmit() {
    alert('This is a demo! In the real app, your profile would be saved to the database.');
  }
...
<div class="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-4 mb-6">
  <div class="flex">
    ...
    <div class="ml-3">
      <p class="text-sm">
        <strong>Demo Mode:</strong> This is a demonstration of the profile editing features. In the real app, you would need to sign up/login to access this page.
        <a href="/login" class="underline ml-2">Go to Login →</a>
      </p>
    </div>
  </div>
</div>
...
<div class="container mx-auto px-4 py-8">
  <div class="max-w-6xl mx-auto">
    <h1 class="text-3xl font-bold mb-8">Edit Your Portfolio <span class="badge badge-warning">DEMO</span></h1>
            ...
            <div class="card-body">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                ...
                <div class="form-control">
                  ...
                  />
                  <label class="label">
                    <span class="label-text-alt">Portfolio URL: /{demoProfile.username}</span>
                  </label>
                </div>
              </div>
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                ...
                <div class="form-control">
                  ...
                  />
                  <label class="label">
                    <span class="label-text-alt">This can be an affiliate link.</span>
                  </label>
                </div>
                <div class="form-control">
                  ...
                  />
                  <label class="label">
                    <span class="label-text-alt">Include country code (e.g., +1 for US)</span>
                  </label>
                </div>
              </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {#each themes as theme}
                    <label class="cursor-pointer">
                      ...
                      />
                      <div class="card bg-base-100 border-2 {selectedTheme === theme.id ? 'border-primary' : 'border-base-300'} hover:border-primary transition-colors">
                        <div class="card-body p-4">
                          <div class="h-16 rounded {theme.preview} mb-2 flex items-center justify-center">
        ...
        <div class="lg:col-span-1">
          <div class="card bg-base-100 shadow-xl sticky top-8">
            <div class="card-body">
              ...
              <!-- Theme Preview -->
              <div class="rounded-lg p-6 mb-4 {themes.find(t => t.id === selectedTheme)?.preview || 'bg-gradient-to-r from-purple-50 to-blue-50'}">
                <div class="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    <h3 class="text-xl font-bold {selectedTheme === 'dark' ? 'text-white' : 'text-gray-800'}">{demoProfile.full_name}</h3>
                    <p class="text-sm {selectedTheme === 'dark' ? 'text-gray-300' : 'text-gray-600'}">{demoProfile.bio}</p>
                  </div>
                </div>

                {#if demoProfile.website}
                  <div class="mb-3">
                    <a href={demoProfile.website} class="text-blue-600 text-sm">🔗 {demoProfile.website}</a>
                  </div>
                {/if}
              ...
              <div class="bg-base-200 p-4 rounded-lg mb-4">
                ...
                <div class="flex items-center gap-2">
                  <code class="text-xs bg-base-300 px-2 py-1 rounded flex-1 break-all">{previewUrl}</code>
                  <button 
                    type="button"
              ...
              <div class="card-actions justify-center">
                <a href="/demo" target="_blank" class="btn btn-outline btn-primary btn-sm">
                  View Live Portfolio
