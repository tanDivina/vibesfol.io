        ...
        <div class="flex-1 text-center md:text-left">
          ...
          <div class="flex justify-center md:justify-start gap-4">
            {#if guestProfile.github_url}
              <a href={guestProfile.github_url} target="_blank" rel="noopener noreferrer" aria-label="GitHub Profile">
                <div class="w-8 h-8 bg-gray-800 rounded flex items-center justify-center hover:bg-gray-700 transition-colors" aria-label="GitHub Profile">
            ...
            {#if guestProfile.linkedin_url}
              <a href={guestProfile.linkedin_url} target="_blank" rel="noopener noreferrer" aria-label="LinkedIn Profile">
                <div class="w-8 h-8 bg-blue-600 rounded flex items-center justify-center hover:bg-blue-700 transition-colors" aria-label="LinkedIn Profile">
                  <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
            ...
            {#if guestProfile.twitter_url}
              <a href={guestProfile.twitter_url} target="_blank" rel="noopener noreferrer" aria-label="Twitter Profile">
                <div class="w-8 h-8 bg-blue-400 rounded flex items-center justify-center hover:bg-blue-500 transition-colors" aria-label="Twitter Profile">
                  <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
            ...
            {#if guestProfile.medium_url}
              <a href={guestProfile.medium_url} target="_blank" rel="noopener noreferrer" aria-label="Medium Profile">
                <div class="w-8 h-8 bg-black rounded flex items-center justify-center hover:bg-gray-800 transition-colors" aria-label="Medium Profile">
                  <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
