        ...
        <div class="flex justify-center md:justify-start gap-4">
          ...
          {#if data.user.medium_url}
            ...
            >
              <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                <path
                  d="M13.54 12a6.83 6.83 0 00-6.82-6.82H0v13.64h.3c.82 0 1.5.27 1.5 1.23v-1.23h1.82v-7.7H5.5v7.7h2.73v-5.45c0-1.5.82-2.73 2.73-2.73s2.73 1.23 2.73 2.73v5.45h2.73v-7.7h1.82v7.7h.3c.82 0 1.5-.27 1.5-1.23v1.23h.3V5.18h-6.82A6.83 6.83 0 0013.54 12z"
                />
              </svg>
            </a>
          {/if}
          {#if data.user.gumroad_url}
            ...
            >
              <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                <path
                  d="M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm0 2.182c5.42 0 9.818 4.398 9.818 9.818s-4.398 9.818-9.818 9.818-9.818-4.398-9.818-9.818 4.398-9.818 9.818-9.818zm-2.727 4.364h5.455v2.727h-5.455v-2.727zm0 4.363h5.455v2.727h-5.455v-2.727z"
                />
              </svg>
            </a>
          {/if}
          {#if data.user.substack_url}
            ...
            >
              <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                <path
                  d="M22.532 2.468H1.468C.657 2.468 0 3.125 0 3.936v16.128c0 .811.657 1.468 1.468 1.468h21.064c.811 0 1.468-.657 1.468-1.468V3.936c0-.811-.657-1.468-1.468-1.468zM7.34 18.293H3.67V9.117h3.67v9.176zm7.34 0h-3.67V9.117h3.67v9.176zm7.34-12.95h-3.67v3.67h3.67V5.343z"
                />
              </svg>
            </a>
          {/if}
          ...
          {#if data.user.whatsapp_number}
            <a
              href="https://wa.me/{data.user.whatsapp_number.replace(
                /[^0-9]/g,
                '',
              )}"
