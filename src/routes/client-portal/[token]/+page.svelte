<script lang="ts">
  ...
  let portal: Database['public']['Tables']['client_portals']['Row'] | null = null;
  let loading = true;
...
<svelte:head>
  <title>{portal?.client_name ? `${portal.client_name}'s Portal` : 'Client Portal'} | MyDevfol.io</title>
</svelte:head>
    ...
    <div class="card bg-base-100 shadow-xl">
      <div class="card-body">
        ...
        <div class="mt-8">
          ...
          <p class="text-gray-600">This section will display project files, mockups, and progress updates.</p>
