<script lang="ts">
  ...
  async function togglePublished(testimonial: Database["public"]["Tables"]["testimonials"]["Row"]) {
    try {
      const { data: { user } } = await supabase.auth.getUser()
      if (!user) throw new Error("User not authenticated")
      ...
      await loadTestimonials()
      toasts.success(`Testimonial ${!testimonial.is_published ? 'published' : 'unpublished'} successfully!`)
    } catch (err: any) {
...
<div class="container mx-auto px-4 py-8">
  <div class="flex justify-between items-center mb-8">
    <div>
      ...
      <p class="text-gray-600 mt-2">Manage testimonials from your clients and showcase social proof</p>
    </div>
          ...
          <div class="card-body">
            ...
            <div class="card-actions justify-between items-center">
              <div class="flex items-center gap-2">
                <button
                  class="btn btn-sm {testimonial.is_published ? 'btn-success' : 'btn-warning'}"
      ...
      <form onsubmit={handleSubmit}>
        <div class="space-y-4">
          ...
          <div class="form-control">
            ...
            <div class="label">
              <span class="label-text-alt">Published testimonials will appear on your public portfolio</span>
            </div>
          </div>
        </div>
