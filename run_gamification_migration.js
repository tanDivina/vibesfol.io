...
const supabaseServiceKey =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InptaGtydnJkbWpuZGt0YmRlZGJrIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTczNjEyNzI5NCwiZXhwIjoyMDUxNzAzMjk0fQ.fIOPXHDBBbueDFaYFq616g_v2uFqH_8"
...
async function runMigration() {
  try {
    ...
    const migrationSQL = fs.readFileSync(
      join(__dirname, "gamification_migration.sql"),
      "utf8",
    )
